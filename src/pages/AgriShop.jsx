...
function readStoredProducts() {
    try {
        ...
        return Array.isArray(stored) ? stored.filter((product) => product.status === 'approved' && (product.id?.startsWith('admin-') || product.id?.startsWith('med-'))) : []
    } catch { return [] }
}
